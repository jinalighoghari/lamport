...
server.bind("0.0.0.0:40001", grpc.ServerCredentials.createInsecure());
server.addService(lamportMessage.message_service.service, {
  message_exchange: message_exchange,
});
server.start();

const globalProcessID = 1;
let local_clock = 0;
let clock_array = [];
let id = 1;

const all_processes = {
  process_2: new lamportMessage.message_service("localhost:40002", grpc.credentials.createInsecure()),
